...
<head>
	...
	function validate() {
		...
		localStorage.setItem("phno", phno1);
...
<body>
    ...
    <div class="row contact-rooo no-margin">
        <div class="container">
	    	...
	    	<form name="myform" onsubmit="return(validate())" action="message.html" method="get" target="_blank">
                    ...
                    <div  class="row cont-row">
                        ...
                        <div class="col-sm-8">
                            <textarea rows="5" placeholder="Enter Your Message" class="form-control input-sm" name="text"></textarea>
                        </div>
                    </div>
